...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate an asynchronous login process with a 2-second delay
    setTimeout(() => {
      setIsLoading(false); // Set loading state back to false
      navigate('/'); // Navigate to the home page after login simulation
    }, 2000);
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center font-inter">
      ...
      {/* This div acts as the main wrapper for the left and right panels,
          applying rounded corners, shadow, and a border. */}
<div className="bg-gray-800 rounded-xl shadow-2xl flex w-full max-w-6xl overflow-hidden border border-gray-700">

        {/* Left side - Brand message and simplified text */}
        {/* Hidden on small screens, shown as a flex column on large screens */}
        <div className="hidden lg:flex flex-col w-1/2 p-12 bg-gradient-to-br from-gray-900 to-gray-800 rounded-l-xl justify-center items-center text-center">
          <div className="max-w-md">
            ...
            {/* Main message on the left panel */}
        ...
        {/* Uses flexbox to center its content horizontally and vertically */}
        <div className="w-full lg:w-1/2 p-8 flex items-center justify-center">
          <div className="w-full max-w-md">
            {/* AptWise icon for smaller screens (hidden on large) */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-2 px-4 rounded-md font-semibold transition-all duration-300 transform hover:scale-105
                  ${isLoading
                    ? 'bg-cyan-600 cursor-not-allowed' // Styles when loading
                    : 'bg-cyan-500 hover:bg-cyan-600' // Styles when not loading
