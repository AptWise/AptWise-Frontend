          ...
          <div className="mb-12 pt-6">
            <div className="mb-4">
              <div>
                ...
                <p className="text-xl text-[#A0A0A0]">Elevate your career with intelligent interview preparation</p>
              </div>
            </div>
          </div>
          ...
          {user && (
            <div className="mb-12">
              <div className="bg-[#1A1A1A] rounded-lg border-2 border-[#00F0FF]/20 shadow-[0_0_30px_rgba(0,240,255,0.15)] overflow-hidden">
                {/* Header */}
                <div className="bg-[#0D0D0D] p-6 border-b-2 border-[#00F0FF]/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-[#00F0FF] rounded-lg flex items-center justify-center">
                        <svg className="w-6 h-6 text-[#0D0D0D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <h2 className="text-2xl font-bold text-white font-['Orbitron']">Profile Command Center</h2>
                    </div>
                    <button
                      onClick={() => handleEditProfile('profile')}
                      className="px-6 py-3 bg-[#00F0FF] hover:bg-[#00F0FF] text-[#0D0D0D] border-2 border-[#00F0FF]/30 rounded-lg transition-all duration-300 flex items-center space-x-2 hover:transform hover:-translate-y-1"
                    >
                ...
                <div className="p-8 bg-[#1A1A1A] bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D]">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-4">
                      <div>
                        <div className="bg-[#0D0D0D] rounded-lg p-6 border-2 border-[#00F0FF]/20 hover:border-[#00F0FF] hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all duration-300">
                          <div className="flex items-center space-x-3 mb-4">
                            <div className="w-10 h-10 bg-[#00F0FF] rounded-lg flex items-center justify-center">
                              <svg className="w-5 h-5 text-[#0D0D0D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                              </svg>
                            </div>
                            <h3 className="text-lg font-semibold text-white font-['Space_Grotesk']">Personal Data</h3>
                          </div>
                          <div className="space-y-4 bg-[#1A1A1A]/40 p-4 rounded-lg border border-[#00F0FF]/10">
                            <div>
                              <label className="block text-[#00F0FF] text-sm font-medium mb-1">Full Name</label>
                              <p className="text-white">{user.name || 'Not provided'}</p>
                            </div>
                            <div>
                              <label className="block text-[#00F0FF] text-sm font-medium mb-1">Email Address</label>
                              <p className="text-[#A0A0A0] break-all">{user.email}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-[#0D0D0D] rounded-lg p-6 border-2 border-[#00F0FF]/20 hover:border-[#00F0FF] hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all duration-300">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <h3 className="text-lg font-semibold text-white font-['Space_Grotesk']">Skills Matrix</h3>
                            </div>
                            <button
                              onClick={() => handleEditProfile('skills')}
                              className="px-3 py-1 bg-transparent hover:bg-[#00F0FF]/10 text-[#00F0FF] border-2 border-[#00F0FF] rounded-lg text-sm transition-all duration-300"
                            >
                              Manage
                            </button>
                          </div>
                          <div className="bg-[#1A1A1A]/40 p-4 rounded-lg border border-[#00F0FF]/10">
                            <div className="space-y-2 max-h-32 overflow-y-auto custom-scrollbar">
                              {userSkills.length > 0 ? (
                                userSkills.map((skillData, index) => (
                                  <div key={index} className="flex items-center justify-between p-3 bg-[#1A1A1A] hover:bg-[#1A1A1A]/80 rounded-lg border border-[#00F0FF]/20 hover:border-[#00F0FF] transition-all duration-200">
                                ...
                                <div className="text-center py-6">
                                  <div 
                                    className="w-16 h-16 bg-[#1A1A1A] rounded-full flex items-center justify-center mx-auto mb-3 cursor-pointer hover:bg-[#00F0FF]/10 border-2 border-[#00F0FF] transition-colors duration-300 shadow-[0_0_15px_rgba(0,240,255,0.2)]"
                                    onClick={() => handleEditProfile('skills')}
                                  >
                                  ...
                                  <p className="text-[#A0A0A0] text-sm">No skills added yet</p>
                                </div>
                              )}
                            </div>
                          </div>
                      ...
                      <div>
                        <div className="bg-[#0D0D0D] rounded-lg p-6 border-2 border-[#00F0FF]/20 hover:border-[#00F0FF] hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all duration-300">
                          <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-white font-['Space_Grotesk']">Connection Hub</h3>
                          </div>
                          <div className="space-y-3 bg-[#1A1A1A]/40 p-4 rounded-lg border border-[#00F0FF]/10">
                            {/* LinkedIn */}
                            <div className="flex items-center justify-between p-3 bg-[#1A1A1A] hover:bg-[#1A1A1A]/80 rounded-lg border border-[#00F0FF]/20 hover:border-[#00F0FF] transition-all duration-200">
                              <div className="flex items-center space-x-3">
                                <div className="w-8 h-8 bg-[#1A1A1A] rounded-lg flex items-center justify-center border border-[#00F0FF]/30 shadow-[0_0_5px_rgba(0,240,255,0.2)]">
                                  <svg className="w-4 h-4 text-[#00F0FF]" viewBox="0 0 24 24">
                              ...
                              <div className={`px-3 py-1 rounded-full text-xs font-medium ${user.is_linkedin_connected ? 'bg-[#00F0FF]/10 text-[#00F0FF] border border-[#00F0FF]/30 shadow-[0_0_5px_rgba(0,240,255,0.2)]' : 'bg-[#1A1A1A] text-[#A0A0A0] border border-[#A0A0A0]/20'}`}>
                            ...
                            <div className="flex items-center justify-between p-3 bg-[#1A1A1A] hover:bg-[#1A1A1A]/80 rounded-lg border border-[#00F0FF]/20 hover:border-[#00F0FF] transition-all duration-200">
                              ...
                              <div className={`px-3 py-1 rounded-full text-xs font-medium ${user.is_github_connected ? 'bg-[#00F0FF]/10 text-[#00F0FF] border border-[#00F0FF]/30 shadow-[0_0_5px_rgba(0,240,255,0.2)]' : 'bg-[#1A1A1A] text-[#A0A0A0] border border-[#A0A0A0]/20'}`}>
            ...
            <div className="bg-[#1A1A1A] rounded-lg border-2 border-[#00F0FF]/20 shadow-[0_0_30px_rgba(0,240,255,0.15)] overflow-hidden">
              ...
              <div className="bg-[#0D0D0D] p-6 border-b-2 border-[#00F0FF]/30">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <h2 className="text-2xl font-bold text-white font-['Orbitron']">Mock Interview</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-[#1A1A1A] bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D]">
                ...
                <button 
                  ...
                  className="w-full py-4 bg-[#00F0FF] hover:bg-[#00F0FF] text-[#0D0D0D] font-bold rounded-lg transition-all duration-300 hover:transform hover:-translate-y-1 flex items-center justify-center space-x-3 text-lg mb-4"
                >
                ...
                <button 
                  ...
                  className="w-full py-3 bg-[#1A1A1A] hover:bg-[#2A2A2A] text-[#00F0FF] font-semibold rounded-lg transition-all duration-300 hover:transform hover:-translate-y-1 flex items-center justify-center space-x-3 border border-[#00F0FF]/20 hover:border-[#00F0FF]/40"
                >
