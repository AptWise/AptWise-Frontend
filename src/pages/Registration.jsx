        ...
        <div className="p-2 md:p-8 flex flex-col items-center">
            ...
            <div className="w-full max-w-md">
              ...
              <form className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    type="button"
                    className="flex items-center justify-center py-2 px-4 border border-gray-600 rounded-lg hover:bg-gray-700 transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-gray-400"
                  >
          ...
          {step === 2 && (
            <div className="w-full max-w-md">
              ...
              <p className="text-gray-400 text-sm mb-6 text-center">Connect your accounts for better recommendations (optional)</p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                <button 
                  className="flex flex-col items-center justify-center p-4 border border-gray-600 rounded-lg hover:bg-gray-700 transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-800"
                >
